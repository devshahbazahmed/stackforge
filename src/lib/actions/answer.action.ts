...
import { ActionResponse, Answer as AnswerTypes, ErrorResponse } from "@/types/global";
...
): Promise<ActionResponse<{ answers: AnswerTypes[]; isNext: boolean; totalAnswers: number }>> {
