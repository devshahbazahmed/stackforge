...
import { ActionResponse, ErrorResponse, Question as QuestionResponse } from "@/types/global";
...
export async function editQuestion(params: EditQuestionParams): Promise<ActionResponse<QuestionResponse>> {
...
export async function getQuestion(params: GetQuestionParams): Promise<ActionResponse<QuestionResponse>> {
