...
import { ActionResponse, ErrorResponse, PaginatedSearchParams, Question as QuestionResponse } from "@/types/global";
...
): Promise<ActionResponse<{ questions: QuestionResponse[]; isNext: boolean }>> {
